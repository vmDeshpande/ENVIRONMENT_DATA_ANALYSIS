document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateUI(data) {
    ...
    if (!data || Object.keys(data).length === 0) {
        card.innerHTML = '<p class="text-center">No data available</p>';
        return;
    }
...
//     <div>
//     <h2>Air Quality</h2>
//     <p>AQI: ${data.airQualityIndex}<br>Real Feel: ${data.feelslike_c} °C<br>Pressure: ${data.pr} mbar</p><br>
//     <h2>Weather</h2>
//     <p>Temperature: ${data.temperature}°C<br>Condition: ${data.condition ? data.condition.text : 'Data not available'}<br>Humidity: ${data.humidity}%</p><br>
//     <h2>Wind</h2>
//     <p>Gust: ${data.gust_kph} Km/h<br>Wind Degree: ${data.wind_degree}<br>Wind: ${data.wind_kph} Km/h</p><br>
//     <h2>Your Location</h2>
//     <p><i class="fas fa-map-marker-alt fa-lg mb-3 text-primary"></i> City: ${data.location.name}<br>
//     <i class="fas fa-map fa-lg mb-3 text-info"></i> Region: ${data.location.region}<br>
//     <i class="fas fa-globe fa-lg mb-3 text-success"></i> Country: ${data.location.country}<br>
//     <i class="far fa-clock fa-lg mb-3 text-warning"></i> Local Time: ${data.location.time}</p>
//     </div>
//   </div>
// </div>
// </div>
...
<div class="cardm">
  <div class="card">
    ...
    <div class="main">${data.temperature}°C</div>
  ...
  <div class="card2">
    <div class="upper">
      <div class="humidity">
        <div class="humiditytext">Humidity<br>${data.humidity}%</div>
      ...
      <div class="air">
        <div class="airtext">Wind<br>${data.wind_kph} Km/h</div>
    ...
    <div class="lower">
      <div class="aqi">
        ...
        <div class="aqitext">AQI<br>${data.airQualityIndex}</div>
      </div>
      ...
      <div class="realfeel">
        ...
        <div class="realfeeltext">Real Feel<br>${data.feelslike_c} °C</div>
      </div>
      ...
      <div class="pressure">
        ...
        <div class="pressuretext">Pressure<br>${data.pr} mbar</div>
      </div>
      <div class="card3">
      Healthy
      </div>
